...
module.exports = {
    ...
    commentBook: async (_id,comment) => {
        return await Book.findByIdAndUpdate(_id,{comments:[...this.comments, comment]},{new:true}) //*** DEBO COMPROBAR QUE ESTA FUNCIÓN HAGA LO QUE YO CREO QUE VA A HACER 😅😅😅😅
    },
